...
if __name__ == "__main__":
    ...
    # # Save the features
    df.to_csv('tmpdatasets/AlphagenomeIndexWrongCelltype.tsv', sep="\t")
    TRACK_NAMES.to_csv("tmpdatasets/TrackNamesWrongCelltype.tsv", sep="\t")
